...
#pragma omp parallel for firstprivate(finalNet, tftfNetwork) num_threads(nthreads)// schedule(dynamic) //dynamic schedule because inner loop is different size for each thread
